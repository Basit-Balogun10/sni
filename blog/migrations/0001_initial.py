# Generated by Django 3.1.5 on 2021-07-03 09:27
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author_img', models.ImageField(upload_to=blog.models.author_img_upload_location)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reply', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='reply_reports', to='blog.blogpost')),
        ...
        migrations.AddField(
            model_name='blogpost',
            name='reports',
            field=models.ManyToManyField(blank=True, default=None, related_name='reports', through='blog.PostReport', to=settings.AUTH_USER_MODEL),
        ),
    ]
